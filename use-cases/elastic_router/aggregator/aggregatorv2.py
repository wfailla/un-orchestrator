...
#    pdb.set_trace()
    ...
    genclient = Aggregatorv2(name=args.name, dealerurl=args.dealer, customer=args.customer,keyfile=args.keyfile, topics=args.topics, dbname = args.dbname, dbuser = args.dbuser, dbpass = args.dbpassword, dbhost = dbhost, dbport = dbport)
