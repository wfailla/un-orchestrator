...
cparser_result_t
cparser_glue_show_subscriptions (cparser_t * parser)
{
...
cparser_result_t
cparser_glue_show_status (cparser_t * parser)
{
...
cparser_result_t
cparser_glue_subscribe_topic_scope (cparser_t * parser)
{
  char *topic_val;
  char **topic_ptr = NULL;
  char *scope_val;
  ...
  assert (CPARSER_OK == rc);
  scope_ptr = &scope_val;
  cparser_cmd_subscribe_topic_scope (&parser->context, topic_ptr, scope_ptr);
  return CPARSER_OK;
}

cparser_result_t
cparser_glue_no_subscribe_topic_scope (cparser_t * parser)
{
  char *topic_val;
  char **topic_ptr = NULL;
  char *scope_val;
  ...
  assert (CPARSER_OK == rc);
  scope_ptr = &scope_val;
  cparser_cmd_no_subscribe_topic_scope (&parser->context,
					topic_ptr, scope_ptr);
  return CPARSER_OK;
}

cparser_result_t
cparser_glue_publish_topic_message (cparser_t * parser)
{
  char *topic_val;
  char **topic_ptr = NULL;
  char *message_val;
  ...
  cparser_cmd_publish_topic_message (&parser->context,
				     topic_ptr, message_ptr);
  return CPARSER_OK;
}
...
cparser_glue_notify_destination_message (cparser_t * parser)
{
  ...
  assert (CPARSER_OK == rc);
  message_ptr = &message_val;
  cparser_cmd_notify_destination_message (&parser->context,
					  destination_ptr, message_ptr);
  return CPARSER_OK;
}
...
cparser_result_t
cparser_glue_help (cparser_t * parser)
{
...
cparser_node_t cparser_node_notify_destination_message_eol = {
  CPARSER_NODE_END,
  0,
  cparser_glue_notify_destination_message,
...
cparser_node_t cparser_node_notify = {
  CPARSER_NODE_KEYWORD,
  0,
  "notify",
  NULL,
...
cparser_node_t cparser_node_publish_topic_message_eol = {
  CPARSER_NODE_END,
  0,
  cparser_glue_publish_topic_message,
...
cparser_node_t cparser_node_publish = {
  CPARSER_NODE_KEYWORD,
  0,
  "publish",
  NULL,
...
cparser_node_t cparser_node_no_subscribe_topic_scope_eol = {
  CPARSER_NODE_END,
  0,
  cparser_glue_no_subscribe_topic_scope,
  "Unsubscribe to topic/scope",
  NULL,
  NULL
};
...
cparser_node_t cparser_node_subscribe_topic_scope_eol = {
  CPARSER_NODE_END,
  0,
  cparser_glue_subscribe_topic_scope,
  "Subscribe to topic/scope",
  NULL,
  NULL
};
...
cparser_node_t cparser_node_show_subscriptions_eol = {
  CPARSER_NODE_END,
  0,
  cparser_glue_show_subscriptions,
...
cparser_node_t cparser_node_show_subscriptions = {
  ...
  "subscriptions",
  NULL,
  &cparser_node_show_status,
  &cparser_node_show_subscriptions_eol
};
